...
exports.Notification = exports.Notifications = undefined;
...
var Notifications = exports.Notifications = function (_Component) {
  ...
  function Notifications() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Notifications.__proto__ || Object.getPrototypeOf(Notifications)).call.apply(_ref, [this].concat(args))), _this), _this.getStyle = function () {
      var style = {
        position: 'fixed',
        minWidth: 325
      };
...
Notifications.filterOpen = function (notification) {
  return notification.open;
};

Notifications.shuffleNotifications = function (tempNotifications) {
...
var Notification = exports.Notification = function (_Component2) {
